<!-- COPY of the canonical protocol at prompts/bootstrap.md in the loreport repo.
     It ships here so a copied brain-template/ is self-contained: make-surface.sh
     needs it. Refresh it from the repo if the protocol is updated. -->
# Brain protocol
